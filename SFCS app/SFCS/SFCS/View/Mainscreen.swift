    ...
    var body: some View{
      ...
      ZStack {
            ...
            VStack{
                ...
                GeometryReader{g in
                    Carousel(height: g.frame(in: .global).height, width: UIScreen.main.bounds.width, cart: self.$cart, page: self.$page, menu: self.$menu)
                }
...
struct PageControl : UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIPageControl {
        ...
        view.numberOfPages = bestseller.count
        return view
    }
...
struct Carousel : UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIScrollView{
        ...
        let total = width * CGFloat(bestseller.count)
